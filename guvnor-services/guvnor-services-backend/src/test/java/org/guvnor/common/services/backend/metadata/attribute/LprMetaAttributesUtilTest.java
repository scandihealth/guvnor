...
public class LprMetaAttributesUtilTest {
    ...
    public void cleanupTest() {
        ...
        assertNull( returnedContent.get( IS_VALID_FOR_PRIMARY_SECTOR_REPORTS ));
    ...
    public void toMapWildcardTest() {
        ...
        assertEquals( mock.isValidForPrimarySectorReports(), returnedContent.get( IS_VALID_FOR_PRIMARY_SECTOR_REPORTS ));
    }
